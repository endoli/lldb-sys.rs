...
LLDB_API size_t SBProcessPutSTDIN(SBProcessRef instance, const char *src, size_t src_len);

LLDB_API size_t SBProcessGetSTDOUT(SBProcessRef instance, char *dst, size_t dst_len);

LLDB_API size_t SBProcessGetSTDERR(SBProcessRef instance, char *dst, size_t dst_len);

LLDB_API size_t SBProcessGetAsyncProfileData(SBProcessRef instance, char *dst, size_t dst_len);
...
LLDB_API uint32_t SBProcessGetStopID(SBProcessRef instance, bool include_expression_stops);

LLDB_API size_t SBProcessReadMemory(SBProcessRef instance, lldb_addr_t addr, void *buf, size_t size,
                                              SBErrorRef error);

LLDB_API size_t SBProcessWriteMemory(SBProcessRef instance, lldb_addr_t addr, void *buf, size_t size,
                                               SBErrorRef error);
...
LLDB_API uint32_t SBProcessGetNumSupportedHardwareWatchpoints(SBProcessRef instance, SBErrorRef error);

LLDB_API uint32_t SBProcessLoadImage(SBProcessRef instance, SBFileSpecRef image_spec,
                                         SBErrorRef error);
