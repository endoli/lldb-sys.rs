...
LLDB_API SBFrameRef SBThreadSetSelectedFrame(SBThreadRef instance, uint32_t frame_idx);
...
LLDB_API bool SBThreadGetDescription(SBThreadRef instance, SBStreamRef description);
