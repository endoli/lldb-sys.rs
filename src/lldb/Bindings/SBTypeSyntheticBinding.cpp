...
SBTypeSyntheticCreateWithClassName(const char *data, uint32_t options)
{
    return reinterpret_cast<SBTypeSyntheticRef>(
        new SBTypeSynthetic(lldb::SBTypeSynthetic::CreateWithClassName(data, options)));
}
...
bool
SBTypeSyntheticIsValid(SBTypeSyntheticRef instance)
{
...
bool
SBTypeSyntheticIsClassCode(SBTypeSyntheticRef instance)
{
    SBTypeSynthetic *unwrapped = reinterpret_cast<SBTypeSynthetic *>(instance);
...
bool
SBTypeSyntheticIsClassName(SBTypeSyntheticRef instance)
{
    SBTypeSynthetic *unwrapped = reinterpret_cast<SBTypeSynthetic *>(instance);
...
const char *
SBTypeSyntheticGetData(SBTypeSyntheticRef instance)
{
    SBTypeSynthetic *unwrapped = reinterpret_cast<SBTypeSynthetic *>(instance);
...
void
SBTypeSyntheticSetClassName(SBTypeSyntheticRef instance, const char *data)
{
    SBTypeSynthetic *unwrapped = reinterpret_cast<SBTypeSynthetic *>(instance);
...
void
SBTypeSyntheticSetClassCode(SBTypeSyntheticRef instance, const char *data)
{
    SBTypeSynthetic *unwrapped = reinterpret_cast<SBTypeSynthetic *>(instance);
...
void
SBTypeSyntheticSetOptions(SBTypeSyntheticRef instance, uint32_t var0)
{
    SBTypeSynthetic *unwrapped = reinterpret_cast<SBTypeSynthetic *>(instance);
...
bool
SBTypeSyntheticGetDescription(SBTypeSyntheticRef instance, SBStreamRef description,
...
bool
SBTypeSyntheticIsEqualTo(SBTypeSyntheticRef instance, SBTypeSyntheticRef rhs)
{
    SBTypeSynthetic *unwrapped = reinterpret_cast<SBTypeSynthetic *>(instance);
