...
const char *
SBErrorGetCString(SBErrorRef instance)
{
...
void
SBErrorClear(SBErrorRef instance)
{
    SBError *unwrapped = reinterpret_cast<SBError *>(instance);
    unwrapped->Clear();
}
...
bool
SBErrorFail(SBErrorRef instance)
{
    SBError *unwrapped = reinterpret_cast<SBError *>(instance);
...
bool
SBErrorSuccess(SBErrorRef instance)
{
    SBError *unwrapped = reinterpret_cast<SBError *>(instance);
...
enum lldb::ErrorType
SBErrorGetType(SBErrorRef instance)
{
    SBError *unwrapped = reinterpret_cast<SBError *>(instance);
...
void
SBErrorSetError(SBErrorRef instance, uint32_t err, lldb::ErrorType type)
{
    SBError *unwrapped = reinterpret_cast<SBError *>(instance);
...
void
SBErrorSetErrorToErrno(SBErrorRef instance)
{
    SBError *unwrapped = reinterpret_cast<SBError *>(instance);
...
void
SBErrorSetErrorToGenericError(SBErrorRef instance)
{
    SBError *unwrapped = reinterpret_cast<SBError *>(instance);
...
void
SBErrorSetErrorString(SBErrorRef instance, const char *err_str)
{
    SBError *unwrapped = reinterpret_cast<SBError *>(instance);
...
int
SBErrorSetErrorStringWithFormat(SBErrorRef instance, const char *format, ...)
{
    if (!format)
        return 0;
...
bool
SBErrorIsValid(SBErrorRef instance)
{
    SBError *unwrapped = reinterpret_cast<SBError *>(instance);
...
bool
SBErrorGetDescription(SBErrorRef instance, SBStreamRef description)
{
    SBError *unwrapped = reinterpret_cast<SBError *>(instance);
