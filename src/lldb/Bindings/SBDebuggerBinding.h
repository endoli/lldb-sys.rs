...
#ifndef BINDGEN
typedef unsigned long (*Callback)(void *baton, lldb::SBInputReader *reader, lldb::InputReaderAction notification,
...
#ifndef BINDGEN
LLDB_API SBDebuggerRef SBDebuggerCreate3(bool source_init_files, lldb::LogOutputCallback callback, void *baton);
#endif // BINDGEN
...
LLDB_API void SBDebuggerSetInputFileHandle(SBDebuggerRef instance, FILE *f, bool transfer_ownership);

LLDB_API void SBDebuggerSetOutputFileHandle(SBDebuggerRef instance, FILE *f, bool transfer_ownership);

LLDB_API void SBDebuggerSetErrorFileHandle(SBDebuggerRef instance, FILE *f, bool transfer_ownership);
...
LLDB_API SBCommandInterpreterRef SBDebuggerGetCommandInterpreter(SBDebuggerRef instance);

LLDB_API void SBDebuggerHandleCommand(SBDebuggerRef instance, const char *command);

LLDB_API SBListenerRef SBDebuggerGetListener(SBDebuggerRef instance);

LLDB_API void SBDebuggerHandleProcessEvent(SBDebuggerRef instance, SBProcessRef process,
                                               SBEventRef event, FILE *out, FILE *err);

LLDB_API SBTargetRef SBDebuggerCreateTarget(SBDebuggerRef instance, const char *filename,
                                                    const char *target_triple, const char *platform_name,
                                                    bool add_dependent_modules, SBErrorRef error);

LLDB_API SBTargetRef SBDebuggerCreateTargetWithFileAndTargetTriple(SBDebuggerRef instance,
                                                                           const char *filename,
...
LLDB_API SBTargetRef SBDebuggerCreateTarget2(SBDebuggerRef instance, const char *filename);

LLDB_API bool SBDebuggerDeleteTarget(SBDebuggerRef instance, SBTargetRef target);
...
LLDB_API void SBDebuggerSetSelectedTarget(SBDebuggerRef instance, SBTargetRef target);
...
LLDB_API bool SBDebuggerSetCurrentPlatformSDKRoot(SBDebuggerRef instance, const char *sysroot);

LLDB_API bool SBDebuggerSetUseExternalEditor(SBDebuggerRef instance, bool input);
...
LLDB_API bool SBDebuggerGetDefaultArchitecture(char *arch_name, size_t arch_name_len);
...
#ifndef BINDGEN
LLDB_API void SBDebuggerSetLoggingCallback(SBDebuggerRef instance, lldb::LogOutputCallback log_callback,
                                               void *baton);
#endif // BINDGEN

LLDB_API void SBDebuggerDispatchInput(SBDebuggerRef instance, void *baton, const void *data, size_t data_len);

LLDB_API void SBDebuggerDispatchInput2(SBDebuggerRef instance, const void *data, size_t data_len);
...
LLDB_API void SBDebuggerPushInputReader(SBDebuggerRef instance, SBInputReaderRef reader);
...
LLDB_API SBTypeCategoryRef SBDebuggerGetCategory(SBDebuggerRef instance, const char *category_name);
...
LLDB_API SBTypeFormatRef SBDebuggerGetFormatForType(SBDebuggerRef instance, SBTypeNameSpecifierRef);

LLDB_API SBTypeSummaryRef SBDebuggerGetSummaryForType(SBDebuggerRef instance, SBTypeNameSpecifierRef);

LLDB_API SBTypeFilterRef SBDebuggerGetFilterForType(SBDebuggerRef instance, SBTypeNameSpecifierRef);

LLDB_API SBTypeSyntheticRef
SBDebuggerGetSyntheticForType(SBDebuggerRef instance, SBTypeNameSpecifierRef);

LLDB_API void SBDebuggerRunCommandInterpreter(SBDebuggerRef instance, bool auto_handle_events,
                                                  bool spawn_thread);

LLDB_API void SBDebuggerRunCommandInterpreter2(SBDebuggerRef instance, bool auto_handle_events,
                                                   bool spawn_thread, SBCommandInterpreterRunOptionsRef options,
